...
Exactly 1,000 rows showed up here, and this is not all the data. The api limits the number of rows requested.
...
cases |>
  ...
  labs(
    title = "COVID-19 Cases per 100,000 Residents (2020–2021)",
    subtitle = "Stratified by Public Health Service Region",
    x = "Date",
